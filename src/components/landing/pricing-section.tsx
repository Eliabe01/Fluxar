...
const plans = [
  {
    ...
    features: ["Registro básico", "Gráficos simples", "Criação de orçamentos"],
    variant: "outline",
  },
  {
    name: "Prata",
    ...
    features: ["Tudo do Bronze", "IA Coach Financeiro", "Badges e Streaks", "Rituais Diários"],
    variant: "default",
    highlight: true,
  },
  {
    ...
    features: ["Tudo do Prata", "Contas para família", "Suporte VIP", "Integrações futuras"],
    variant: "outline",
  },
];
